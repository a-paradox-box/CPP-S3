...
int main()
{
    ...
    std::cout << "Sum of the elements of this array :- " << sum_of_an_array(size, new_array) << std::endl;
    std::cout << "Largest element of this array :-" << largest_of_an_array(size, new_array) << std::endl;
}